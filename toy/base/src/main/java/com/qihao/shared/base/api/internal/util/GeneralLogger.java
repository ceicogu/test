...
public class GeneralLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        GeneralLogger.needEnableLogger = needEnableLogger;
    }
    ...
    private static void _logCommError(Exception e, HttpURLConnection conn, String url, String appKey, String method,
                                      Map<String, String> params) {
        DateFormat df = new SimpleDateFormat(GeneralConstants.DATE_TIME_FORMAT);
        df.setTimeZone(TimeZone.getTimeZone(GeneralConstants.DATE_TIMEZONE));
        String sdkName = "AliyunConstants.SDK_VERSION";
        String urlStr = null;
        String rspCode = "";
        if (conn != null) {
            try {
     ...
     * 发生特别错误时记录完整错误现场
     */
    public static void logErrorScene(Map<String, Object> rt, GeneralResponse tRsp, String appSecret) {
        if (!needEnableLogger) {
            return;
        }
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        appendLog((GeneralHashMap) rt.get("protocalMustParams"), sb);
        sb.append("^_^");
        sb.append("ProtocalOptParams:");
        appendLog((GeneralHashMap) rt.get("protocalOptParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        appendLog((GeneralHashMap) rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
    ...
    private static void appendLog(GeneralHashMap map, StringBuilder sb) {
        boolean first = true;
