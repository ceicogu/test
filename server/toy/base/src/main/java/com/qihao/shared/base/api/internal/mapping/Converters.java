...
import com.qihao.shared.base.api.internal.util.StringUtils;
...
public class Converters {
     ...
     * @throws ApiException
     */
    public static <T> T convert(Class<T> clazz, Reader reader) throws GeneralApiException {
        T rsp = null;
        ...
        try {
            ...
            for (PropertyDescriptor pd : pds) {
                ...
                Field field;
                if (baseFields.contains(itemName) && GeneralResponse.class.isAssignableFrom(clazz)) {
                    field = GeneralResponse.class.getDeclaredField(itemName);
                } else {
                ...
                if (String.class.isAssignableFrom(typeClass)) {
                    ...
                    if (value instanceof String) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a String");
                        }
                        if (value != null) {
                            method.invoke(rsp, value.toString());
                        } else {
                    ...
                    if (value instanceof Long) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a Number(Long)");
                        }
                    ...
                    if (value instanceof Integer) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a Number(Integer)");
                        }
                        if (StringUtils.isNumeric(value)) {
                    ...
                    if (value instanceof Boolean) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a Boolean");
                        }
                        if (value != null) {
                    ...
                    if (value instanceof Double) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a Double");
                        }
                    }
                    ...
                    if (value instanceof Number) {
                        ...
                        if (isCheckJsonType && value != null) {
                            throw new GeneralApiException(itemName + " is not a Number");
                        }
                    }
                } else if (Date.class.isAssignableFrom(typeClass)) {
                    DateFormat format = new SimpleDateFormat(GeneralConstants.DATE_TIME_FORMAT);
                    format.setTimeZone(TimeZone.getTimeZone(GeneralConstants.DATE_TIMEZONE));
                    Object value = reader.getPrimitiveObject(itemName);
                    if (value instanceof String) {
