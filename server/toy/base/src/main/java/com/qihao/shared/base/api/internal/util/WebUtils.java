...
public abstract class WebUtils {
    ...
    private static final String DEFAULT_CHARSET = GeneralConstants.CHARSET_UTF8;
    ...
    public static String doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout)
        ...
        try {
            try {
               ...
               GeneralLogger.logCommError(e, url, map.get("app_key"), map.get("method"), content);
                throw e;
            }
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                GeneralLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), content);
                throw e;
            }
    ...
    public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams,
        ...
        try {
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                GeneralLogger.logCommError(e, url, map.get("app_key"), map.get("method"), params);
                throw e;
            }
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                GeneralLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), params);
                throw e;
            }
